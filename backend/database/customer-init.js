...
async function initializeCoreSchema() {
  // Create comprehensive single-tenant schema (matching development database)
  await pool.query(`
    -- 1. Users table (with MFA support - matches development)
    ...
    -- 2. Employees table (comprehensive with compliance and AI features - matches development)
    ...
    -- 3. Violations table (advanced with compliance tracking - matches development)
    ...
    -- 4. Notifications table (comprehensive with delivery tracking - matches development)
    ...
    -- 5. Security policies table (advanced with compliance mapping - matches development)
    ...
    -- 6. Threat categories table (comprehensive with detection patterns - matches development)
    ...
    -- 7. Category keywords table (matches development)
    ...
    -- 8. App settings table (simple key-value store - matches development)
    ...
    -- 9. Employee metrics table (daily behavioral data - matches development)
    ...
    -- 10. Chat messages table (AI assistant conversations - matches development)
    ...
    -- 11. Email communications table (comprehensive email analysis - matches development)
    ...
    -- 12. Internal policies table (advanced policy management - matches development)
    ...
    -- 13. Category detection results table (email analysis results - matches development)
    ...
    -- Create performance indexes (essential ones from development)
  ...
  // Insert comprehensive sample data (matching development database)
  await pool.query(`
    -- Insert app settings
