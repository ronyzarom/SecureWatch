...
CREATE TABLE IF NOT EXISTS compliance_analysis_log (
    ...
    INDEX idx_compliance_analysis_employee (employee_id),
    INDEX idx_compliance_analysis_trigger (trigger_source),
    INDEX idx_compliance_analysis_analyzed_at (analyzed_at),
    INDEX idx_compliance_analysis_ai_risk (ai_risk_score)
);
...
CREATE TABLE IF NOT EXISTS compliance_alerts (
    ...
    -- Indexing
    INDEX idx_compliance_alerts_employee (employee_id),
    INDEX idx_compliance_alerts_status (status),
    INDEX idx_compliance_alerts_severity (severity),
    INDEX idx_compliance_alerts_triggered_by (triggered_by),
